...
assign_resource("Smith", 40, "Stuff")
assign_resource("Murdock", 20, "Planning")
assign_resource("Murdock", 25, "Planning")
assign_resource("Murdock", 15, "Smoking")
assign_resource("Murdock", 25, "Smoking")
